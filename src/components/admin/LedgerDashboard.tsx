  ...
  return (
    <div className="relative w-full flex flex-col items-center">
      <svg viewBox="0 0 200 110" className="w-full max-w-[180px]">
        <path d="M 20 100 A 80 80 0 0 1 180 100" fill="none" stroke="#E5E5E7" strokeWidth="8" strokeLinecap="round" />
        <path d="M 20 100 A 80 80 0 0 1 180 100" fill="none" stroke="#000000" strokeWidth="8" strokeLinecap="round" strokeDasharray={`${angle * 2.79} 999`} />
      </svg>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-start justify-between">
        <div>
          <h1 className="text-4xl font-bold text-black tracking-tight font-['Urbanist']">Accounting</h1>
          ...
          <div className="h-[100px]">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={budgetData}>
                <defs>
                  <linearGradient id="salesGradLedger" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="0%" stopColor="#E0E0E0" stopOpacity={0.4} />
                    <stop offset="100%" stopColor="#E0E0E0" stopOpacity={0} />
                  </linearGradient>
                </defs>
                <Area type="monotone" dataKey="sales" stroke="#A0A0A0" strokeWidth={1.5} fill="url(#salesGradLedger)" dot={false} />
